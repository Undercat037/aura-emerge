...
license=('GPL-3.0')
depends=('aura')
optdepends=('devtools: for --abs support (build from ABS source via pkgctl)' 'gnupg: for PGP verification' 'bubblewrap: sandboxed --abs builds (falls back to unsandboxed with --no-sandbox)')
