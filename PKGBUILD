...
license=('GPL-3.0')
depends=('aura' 'devtools' 'git')
optdepends=('gnupg: for PGP verification' 'bubblewrap: fallback sandboxed builds when devtools/pkgctl is unavailable (falls back further to unsandboxed with --no-sandbox)')
